...
/* Temporary, until multiple buffer support is available for S32CC on RTD*/
#if !(defined(S32G2XX) || defined(S32G3XX) || defined(S32R45))
#define GMAC_SEND_MULTIPLE_BUFFERS
#endif /* !(defined(S32G2XX) || defined(S32G3XX) || defined(S32R45)) */
